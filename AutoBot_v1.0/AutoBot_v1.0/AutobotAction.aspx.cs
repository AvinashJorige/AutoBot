...
{
    public partial class AutobotAction : System.Web.UI.Page
    {
        private static ActionService _service;
        public AutobotAction()
        {
        ...
        public static object ActionInTake(string intakeContent)
        {
            ...
            _autobot = _service.GetActionByAction(intakeContent);
            if (string.IsNullOrEmpty(_autobot.Action))
            {
